...
class TimeEntryTest extends TestCase
{
    ...
    public function test_outside_shift_pending_adjustment_influences_next_outside_clock(): void
    {
        $this->freezeNow('2026-02-16 21:45:00');
        ...
        TimeEntry::create([
            ...
            'clocked_at' => CarbonImmutable::parse('2026-02-16 21:43:00', 'Europe/Madrid'),
            'type' => 'in',
