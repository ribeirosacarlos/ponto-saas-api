...
class SendAffiliatePasswordResetJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Log::info('Sending affiliate password reset email', ['affiliate_id' => $affiliate->id, 'email' => $affiliate->email]);
